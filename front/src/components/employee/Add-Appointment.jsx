    ...
    try {
      ...
      if (res.ok) {
        ...
        setForm({
          ...
          employeId: '', date: '', heure: '', servicesIds: []
        });
    ...
    <div className="container max-w-3xl mx-auto px-4">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Remplissez les détails du client et du rendez-vous</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-2">
                Durée estimée : <strong>{estimatedDuration}</strong>
              </p>
            </div>
